    ...
    <nav className="w-full border-b border-line">
      <div className="mx-auto flex max-w-page items-center justify-between px-6 py-6 sm:px-12 lg:px-20">
        <a href="#" className="flex items-center gap-2.5">
          <span className="flex h-[26px] w-[26px] items-center justify-center rounded-[7px] bg-gradient-to-br from-pink to-pink-soft text-[13px] font-bold text-ink">
            V
          </span>
        ...
        <div className="flex items-center gap-6 sm:gap-9">
          ...
          <div className="flex items-center gap-2 rounded-[20px] border border-line bg-surface px-3.5 py-2">
